...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="9"| ''protocol:''<br/><code>0x20</code><br/><br/>''resource:''<br/><code>explode</code>
 | rowspan="9"| Play
 | rowspan="9"| Client
 | colspan="2"| X
 | colspan="2"| {{Type|Double}}
 |
 |-
 | colspan="2"| Y
 | colspan="2"| {{Type|Double}}
 ...
 |
 |-
 | rowspan="3"| Player Delta Velocity
 | X
 | rowspan="3"| {{Type|Prefixed Optional}}
 | {{Type|Double}}
 | rowspan="3"| Velocity difference of the player being pushed by the explosion.
 |-
 | Y
 | {{Type|Double}}
 |-
 ...
 | {{Type|Double}}
 |-
 | colspan="2"| Explosion Particle ID
 | colspan="2"| {{Type|VarInt}}
 | ID in the <code>minecraft:particle_type</code> registry.
 |-
 | colspan="2"| Explosion Particle Data
 | colspan="2"| Varies
 | Particle data as specified in [[Minecraft Wiki:Projects/wiki.vg merge/Particles|Particles]].
 |-
 | colspan="2"| Explosion Sound
 | colspan="2"| {{Type|ID or}} {{Type|Sound Event}}
...
This packet is used exclusively for opening the horse GUI. [[#Open Screen|Open Screen]] is used for all other GUIs.  The client will not open the inventory if the Entity ID does not point to a horse-like animal.
...
If the player is riding a client-side-controlled vehicle, teleports the vehicle to the specified position. Sent by the vanilla server in response to serverbound [[#Move Vehicle (serverbound)|Move Vehicle]] packets that fail the movement speed check. Note that all fields use absolute positioning and do not allow for relative positioning.
...
Unlike [[#Clientbound Keep Alive (play)|Keep Alive]] this packet is handled synchronously with game logic on the vanilla client, and can thus be used to reliably detect which serverbound packets were sent after the ping and all preceding clientbound packets were received and handled.
...
{| class="wikitable"
 ...
 | {{Type|VarInt}}
 | A counter that starts at zero and gets increased by one for each chat message sent to the client. Each client has its own counter.
 |-
 | colspan="2"| Sender
 | {{Type|UUID}}
...
This is used as the <code>content</code> parameter when formatting the message on the client.
 ...
 | colspan="2"|  Message ID
 | {{Type|VarInt}}
 | The message ID + 1, used for validating message signature. The next field is present only when value of this field is equal to 0.
 |-
 | colspan="2"| Signature
 | {{Type|Optional}} {{Type|Byte Array}} (256)
 | The previous message's signature. Contains the same type of data as <code>Message Signature bytes</code> (256 bytes) above. Not length-prefixed.
 |-
 | rowspan="3"| Other
 ...
 | Only present if the Filter Type is Partially Filtered. Specifies the indices at which characters in the original message string should be replaced with the <code>#</code> symbol (i.e., filtered) by the vanilla client
 |-
...
If the player is riding a vehicle, this packet has no effect, but both the [[#Confirm Teleportation|Confirm Teleportation]] and [[#Set Player Position and Rotation|Set Player Position and Rotation]] packets are still sent.
...
The background of the loading screen is determined based on the Dimension Name specified in this packet and the one specified in the previous Login or Respawn packet. If either the current or the previous dimension is <code>minecraft:nether</code>, the Nether portal background is used. Otherwise, if the current or the previous dimension is <code>minecraft:the_end</code>, the End portal background is used. If the player is dead (health is 0), the default background is always used.
...
{| class="wikitable"
 ...
 | Dimension Type
 | {{Type|VarInt}}
 | The ID of type of dimension in the <code>minecraft:dimension_type</code> registry, defined by the [[#Registry_Data_2|Registry Data]] packet.
 |-
 | Dimension Name
 | {{Type|Identifier}}
 | Name of the dimension being spawned into.
...
{{warning|Avoid changing a player's dimension to the same dimension they were already in unless they are dead. If you change the dimension to one they are already in, weird bugs can occur, such as the player being unable to attack other players in the new world (until they die and respawn).
...
The vanilla client never renders or simulates chunks located outside the loading area, but keeps them in memory (unless explicitly unloaded by the server while still in range), and only automatically unloads a chunk when another chunk is loaded at coordinates congruent to the old chunk's coordinates modulo (2 &times; server view distance + 7). This means that a chunk may reappear after leaving and later re-entering the loading area through successive uses of this packet, unless it is replaced in the meantime by a different chunk in the same "slot".
...
{| class="wikitable"
 ...
 | {{Type|Byte}} {{Type|Enum}}
 | rowspan="2"| The length of the array is not known beforehand and has to be determined by reading all entries, as the most significant bit of the slot indicates if there is a next entry.
...
{| class="wikitable"
 ...
 | Header
 | {{Type|Text Component}}
 | To remove the header, send an empty text component: <code>{"text":""}</code>.
 |-
 | Footer
 | {{Type|Text Component}}
 | To remove the footer, send an empty text component: <code>{"text":""}</code>.
 |}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="9"| ''protocol:''<br/><code>0x83</code><br/><br/>''resource:''<br/><code>waypoint</code>
 | rowspan="9"| Play
 | rowspan="9"| Client
 | colspan="2"| Operation
 ...
 | colspan="2"| {{Type|Uuid}} {{Type|or}} {{Type|String}}
 | Something that uniquely identifies this specific waypoint.
 |-
 | colspan="2"| Icon style
 | colspan="2"| {{Type|Identifier}}
 | Path to the waypoint style JSON: <code>assets/<namespace>/waypoint_style/<value>.json.</code>
 |-
 | rowspan="4"| Color
 |-
 | Red
 | rowspan="3"| {{Type|Prefixed Optional}}
 | {{Type|Unsigned Byte}}
 | rowspan="3"| The color of the waypoint icon.
 |-
 | Green
 | {{Type|Unsigned Byte}}
 |-
 ...
 | {{Type|Unsigned Byte}}
 |-
 | colspan="2"| Waypoint type
| colspan="2"| {{Type|VarInt}} {{Type|Enum}}
 | Defines how the following field is read.
 |-
 | colspan="2"| Waypoint data
 | colspan="2"| Varies
 |
   {| class="wikitable"
    ! Type
    ...
    | X
    | {{Type|VarInt}}
    | rowspan="3"| The position that the waypoint will point to.
    |-
    | Y
    | {{Type|VarInt}}
    |-
    ...
    | X
    | {{Type|VarInt}}
    | rowspan="2"| The chunk coordinates that the waypoint will point to.
    |-
    | Z
    | {{Type|VarInt}}
    |-
    ...
    | Angle
    | {{Type|Float}}
    | The angle that will be pointed to, in radians.
    |}
 |}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | ''protocol:''<br/><code>0x84</code><br/><br/>''resource:''<br/><code>clear_dialog</code>
 | Play
 | Client
 | colspan="3"| ''no fields''
 |}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | ''protocol:''<br/><code>0x85</code><br/><br/>''resource:''<br/><code>show_dialog</code>
 | Play
 | Client
 | Dialog
 | {{Type|ID or}} {{Type|NBT}}
 | ID in the <code>minecraft:dialog</code> registry, or an inline definition as described at [[Java_Edition_protocol/Registry_data#Dialog|Registry_data#Dialog]].
 |}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | ''protocol:''<br/><code>0x04</code><br/><br/>''resource:''<br/><code>change_game_mode</code>
 | Play
 | Server
 | Game mode
 | {{Type|VarInt}} {{Type|Enum}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="1"| ''protocol:''<br/><code>0x05</code><br/><br/>''resource:''<br/><code>chat_ack</code>
 | rowspan="1"| Play
 | rowspan="1"| Server
 | Message Count
 | {{Type|VarInt}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="1"| ''protocol:''<br/><code>0x06</code><br/><br/>''resource:''<br/><code>chat_command</code>
 | rowspan="1"| Play
 | rowspan="1"| Server
 | colspan="2"| Command
 | colspan="2"| {{Type|String}} (32767)
 | colspan="2"| The command typed by the client excluding the <code>/</code>.
 |}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="8"| ''protocol:''<br/><code>0x07</code><br/><br/>''resource:''<br/><code>chat_command_signed</code>
 | rowspan="8"| Play
 | rowspan="8"| Server
 | colspan="2"| Command
 | colspan="2"| {{Type|String}} (32767)
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="7"| ''protocol:''<br/><code>0x08</code><br/><br/>''resource:''<br/><code>chat</code>
 | rowspan="7"| Play
 | rowspan="7"| Server
 | Message
 | {{Type|String}} (256)
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="4"| ''protocol:''<br/><code>0x09</code><br/><br/>''resource:''<br/><code>chat_session_update</code>
 | rowspan="4"| Play
 | rowspan="4"| Server
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="1"| ''protocol:''<br/><code>0x0A</code><br/><br/>''resource:''<br/><code>chunk_batch_received</code>
 | rowspan="1"| Play
 | rowspan="1"| Server
 | Chunks per tick
 | {{Type|Float}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="1"| ''protocol:''<br/><code>0x0B</code><br/><br/>''resource:''<br/><code>client_command</code>
 | rowspan="1"| Play
 | rowspan="1"| Server
 | Action ID
 | {{Type|VarInt}} {{Type|Enum}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | ''protocol:''<br/><code>0x0C</code><br/><br/>''resource:''<br/><code>client_tick_end</code>
 | Play
 | Server
 | colspan="3"| ''no fields''
 |}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="9"| ''protocol:''<br/><code>0x0D</code><br/><br/>''resource:''<br/><code>client_information</code>
 | rowspan="9"| Play
 | rowspan="9"| Server
 | Locale
 | {{Type|String}} (16)
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="2"| ''protocol:''<br/><code>0x0E</code><br/><br/>''resource:''<br/><code>command_suggestion</code>
 | rowspan="2"| Play
 | rowspan="2"| Server
 | Transaction Id
 | {{Type|VarInt}}
 ...
 | Text
 | {{Type|String}} (32500)
 | All the text behind the cursor including the <code>/</code> (e.g. to the left of the cursor in left-to-right languages like English).
 |}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="1"| ''protocol:''<br/><code>0x0F</code><br/><br/>''resource:''<br/><code>configuration_acknowledged</code>
 | rowspan="1"| Play
 | rowspan="1"| Server
 | colspan="3"| ''no fields''
 |}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="2"| ''protocol:''<br/><code>0x10</code><br/><br/>''resource:''<br/><code>container_button_click</code>
 | rowspan="2"| Play
 | rowspan="2"| Server
 | Window ID
 | {{Type|VarInt}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="8"| ''protocol:''<br/><code>0x11</code><br/><br/>''resource:''<br/><code>container_click</code>
 | rowspan="8"| Play
 | rowspan="8"| Server
 | colspan="2"| Window ID
 | colspan="2"| {{Type|VarInt}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="1"| ''protocol:''<br/><code>0x12</code><br/><br/>''resource:''<br/><code>container_close</code>
 | rowspan="1"| Play
 | rowspan="1"| Server
 | Window ID
 | {{Type|VarInt}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="3"| ''protocol:''<br/><code>0x13</code><br/><br/>''resource:''<br/><code>container_slot_state_changed</code>
 | rowspan="3"| Play
 | rowspan="3"| Server
 | Slot ID
 | {{Type|VarInt}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="2"| ''protocol:''<br/><code>0x14</code><br/><br/>''resource:''<br/><code>cookie_response</code>
 | rowspan="2"| Play
 | rowspan="2"| Server
 | Key
 | {{Type|Identifier}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="2"| ''protocol:''<br/><code>0x15</code><br/><br/>''resource:''<br/><code>custom_payload</code>
 | rowspan="2"| Play
 | rowspan="2"| Server
 | Channel
 | {{Type|Identifier}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="1"| ''protocol:''<br/><code>0x16</code><br/><br/>''resource:''<br/><code>debug_sample_subscription</code>
 | rowspan="1"| Play
 | rowspan="1"| Server
 | Sample Type
 | {{Type|VarInt}} {{Type|Enum}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="3"| ''protocol:''<br/><code>0x17</code><br/><br/>''resource:''<br/><code>edit_book</code>
 | rowspan="3"| Play
 | rowspan="3"| Server
 | Slot
 | {{Type|VarInt}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="2"| ''protocol:''<br/><code>0x18</code><br/><br/>''resource:''<br/><code>entity_tag_query</code>
 | rowspan="2"| Play
 | rowspan="2"| Server
 | Transaction ID
 | {{Type|VarInt}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="7"| ''protocol:''<br/><code>0x19</code><br/><br/>''resource:''<br/><code>interact</code>
 | rowspan="7"| Play
 | rowspan="7"| Server
 | Entity ID
 | {{Type|VarInt}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="3"| ''protocol:''<br/><code>0x1A</code><br/><br/>''resource:''<br/><code>jigsaw_generate</code>
 | rowspan="3"| Play
 | rowspan="3"| Server
 | Location
 | {{Type|Position}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="1"| ''protocol:''<br/><code>0x1B</code><br/><br/>''resource:''<br/><code>keep_alive</code>
 | rowspan="1"| Play
 | rowspan="1"| Server
 | Keep Alive ID
 | {{Type|Long}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="1"| ''protocol:''<br/><code>0x1C</code><br/><br/>''resource:''<br/><code>lock_difficulty</code>
 | rowspan="1"| Play
 | rowspan="1"| Server
 | Locked
 | {{Type|Boolean}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="4"| ''protocol:''<br/><code>0x1D</code><br/><br/>''resource:''<br/><code>move_player_pos</code>
 | rowspan="4"| Play
 | rowspan="4"| Server
 | X
 | {{Type|Double}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="6"| ''protocol:''<br/><code>0x1E</code><br/><br/>''resource:''<br/><code>move_player_pos_rot</code>
 | rowspan="6"| Play
 | rowspan="6"| Server
 | X
 | {{Type|Double}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="3"| ''protocol:''<br/><code>0x1F</code><br/><br/>''resource:''<br/><code>move_player_rot</code>
 | rowspan="3"| Play
 | rowspan="3"| Server
 | Yaw
 | {{Type|Float}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="1"| ''protocol:''<br/><code>0x20</code><br/><br/>''resource:''<br/><code>move_player_status_only</code>
 | rowspan="1"| Play
 | rowspan="1"| Server
 | Flags
 | {{Type|Byte}}
...
Sent when a player moves in a client-side-controlled vehicle. Fields are the same as in [[#Set Player Position and Rotation|Set Player Position and Rotation]]. Note that all fields use absolute positioning and do not allow for relative positioning.
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="6"| ''protocol:''<br/><code>0x21</code><br/><br/>''resource:''<br/><code>move_vehicle</code>
 | rowspan="6"| Play
 | rowspan="6"| Server
 | X
 | {{Type|Double}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="2"| ''protocol:''<br/><code>0x22</code><br/><br/>''resource:''<br/><code>paddle_boat</code>
 | rowspan="2"| Play
 | rowspan="2"| Server
 | Left paddle turning
 | {{Type|Boolean}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="2"| ''protocol:''<br/><code>0x23</code><br/><br/>''resource:''<br/><code>pick_item_from_block</code>
 | rowspan="2"| Play
 | rowspan="2"| Server
 | Location
 | {{Type|Position}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="2"| ''protocol:''<br/><code>0x24</code><br/><br/>''resource:''<br/><code>pick_item_from_entity</code>
 | rowspan="2"| Play
 | rowspan="2"| Server
 | Entity ID
 | {{Type|VarInt}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="1"| ''protocol:''<br/><code>0x25</code><br/><br/>''resource:''<br/><code>ping_request</code>
 | rowspan="1"| Play
 | rowspan="1"| Server
 | Payload
 | {{Type|Long}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="3"| ''protocol:''<br/><code>0x26</code><br/><br/>''resource:''<br/><code>place_recipe</code>
 | rowspan="3"| Play
 | rowspan="3"| Server
 | Window ID
 | {{Type|VarInt}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="1"| ''protocol:''<br/><code>0x27</code><br/><br/>''resource:''<br/><code>player_abilities</code>
 | rowspan="1"| Play
 | rowspan="1"| Server
 | Flags
 | {{Type|Byte}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="4"| ''protocol:''<br/><code>0x28</code><br/><br/>''resource:''<br/><code>player_action</code>
 | rowspan="4"| Play
 | rowspan="4"| Server
 | Status
 | {{Type|VarInt}} {{Type|Enum}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="3"| ''protocol:''<br/><code>0x29</code><br/><br/>''resource:''<br/><code>player_command</code>
 | rowspan="3"| Play
 | rowspan="3"| Server
 | Entity ID
 | {{Type|VarInt}}
...
Sent whenever the player presses or releases certain keys. The flags correspond directly to the states of their corresponding keys&mdash;the Sprint flag does not depend on whether the player is actually able to sprint at the moment, etc.

Used by the vanilla server for minecart controls, player inputs in the <code>entity_properties</code> [[predicate]], and sneaking (sprinting is still controlled by [[#Player Command|Player Command]]).
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="1"| ''protocol:''<br/><code>0x2A</code><br/><br/>''resource:''<br/><code>player_input</code>
 | rowspan="1"| Play
 | rowspan="1"| Server
 | Flags
 | {{Type|Unsigned Byte}}
...
Sent by the client to indicate that it is ready to start simulating the player. The vanilla client sends this [[Java Edition protocol/FAQ#…my_player_isn't_spawning!|when the "Loading terrain..." screen is closed]]. (But see the caveat below.)

The vanilla client skips ticking the player entity until the tick on which this packet is sent (the first tick will happen between this packet and the next [[#Client Tick End|Client Tick End]]). Other entities and objects will still be ticked.

Once 60 ticks have elapsed since the last Login or Respawn packet, the vanilla client will start ticking the player and '''skip sending this packet completely''', even after the usual conditions for it have been met. This can happen even before the "Start waiting for level chunks" [[#Game Event|Game Event]] is received. The loading screen is not affected in any way by this timer (except indirectly by the player falling into the void after ticking has started). Likewise, the vanilla server will assume that the client has loaded if it takes longer than 60 server ticks to send this packet. A more robust way to detect this condition is to count the number of [[#Client Tick End|Client Tick End]] packets sent by the client. The first player tick will occur after 60 Client Tick End packets have been sent. To determine when this counter should be restarted following a respawn, the Respawn packet can be sent in a [[#Bundle Delimiter|bundle]] together with a [[#Ping (play)|Ping]] packet.
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="1"| ''protocol:''<br/><code>0x2B</code><br/><br/>''resource:''<br/><code>player_loaded</code>
 | rowspan="1"| Play
 | rowspan="1"| Server
 | colspan="3"| ''no fields''
 |}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="1"| ''protocol:''<br/><code>0x2C</code><br/><br/>''resource:''<br/><code>pong</code>
 | rowspan="1"| Play
 | rowspan="1"| Server
 | ID
 | {{Type|Int}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="3"| ''protocol:''<br/><code>0x2D</code><br/><br/>''resource:''<br/><code>recipe_book_change_settings</code>
 | rowspan="3"| Play
 | rowspan="3"| Server
 | Book ID
 | {{Type|VarInt}} {{Type|Enum}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="1"| ''protocol:''<br/><code>0x2E</code><br/><br/>''resource:''<br/><code>recipe_book_seen_recipe</code>
 | rowspan="1"| Play
 | rowspan="1"| Server
 | Recipe ID
 | {{Type|VarInt}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="1"| ''protocol:''<br/><code>0x2F</code><br/><br/>''resource:''<br/><code>rename_item</code>
 | rowspan="1"| Play
 | rowspan="1"| Server
 | Item name
 | {{Type|String}} (32767)
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="2"| ''protocol:''<br/><code>0x30</code><br/><br/>''resource:''<br/><code>resource_pack</code>
 | rowspan="2"| Play
 | rowspan="2"| Server
 | UUID
 | {{Type|UUID}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="2"| ''protocol:''<br/><code>0x31</code><br/><br/>''resource:''<br/><code>seen_advancements</code>
 | rowspan="2"| Play
 | rowspan="2"| Server
 | Action
 | {{Type|VarInt}} {{Type|Enum}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="1"| ''protocol:''<br/><code>0x32</code><br/><br/>''resource:''<br/><code>select_trade</code>
 | rowspan="1"| Play
 | rowspan="1"| Server
 | Selected slot
 | {{Type|VarInt}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="2"| ''protocol:''<br/><code>0x33</code><br/><br/>''resource:''<br/><code>set_beacon</code>
 | rowspan="2"| Play
 | rowspan="2"| Server
 | Primary Effect
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="1"| ''protocol:''<br/><code>0x34</code><br/><br/>''resource:''<br/><code>set_carried_item</code>
 | rowspan="1"| Play
 | rowspan="1"| Server
 | Slot
 | {{Type|Short}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="4"| ''protocol:''<br/><code>0x35</code><br/><br/>''resource:''<br/><code>set_command_block</code>
 | rowspan="4"| Play
 | rowspan="4"| Server
 | Location
 | {{Type|Position}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="3"| ''protocol:''<br/><code>0x36</code><br/><br/>''resource:''<br/><code>set_command_minecart</code>
 | rowspan="3"| Play
 | rowspan="3"| Server
 | Entity ID
 | {{Type|VarInt}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="2"| ''protocol:''<br/><code>0x37</code><br/><br/>''resource:''<br/><code>set_creative_mode_slot</code>
 | rowspan="2"| Play
 | rowspan="2"| Server
 | Slot
 | {{Type|Short}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="8"| ''protocol:''<br/><code>0x38</code><br/><br/>''resource:''<br/><code>set_jigsaw_block</code>
 | rowspan="8"| Play
 | rowspan="8"| Server
 | Location
 | {{Type|Position}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="17"| ''protocol:''<br/><code>0x39</code><br/><br/>''resource:''<br/><code>set_structure_block</code>
 | rowspan="17"| Play
 | rowspan="17"| Server
 |-
 | Location
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="3"| ''protocol:''<br/><code>0x3A</code><br/><br/>''resource:''<br/><code>set_test_block</code>
 | rowspan="3"| Play
 | rowspan="3"| Server
 | Position
 | {{Type|Position}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="6"| ''protocol:''<br/><code>0x3B</code><br/><br/>''resource:''<br/><code>sign_update</code>
 | rowspan="6"| Play
 | rowspan="6"| Server
 | Location
 | {{Type|Position}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="1"| ''protocol:''<br/><code>0x3C</code><br/><br/>''resource:''<br/><code>swing</code>
 | rowspan="1"| Play
 | rowspan="1"| Server
 | Hand
 | {{Type|VarInt}} {{Type|Enum}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="1"| ''protocol:''<br/><code>0x3D</code><br/><br/>''resource:''<br/><code>teleport_to_entity</code>
 | rowspan="1"| Play
 | rowspan="1"| Server
 | Target Player
 | {{Type|UUID}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="10"| ''protocol:''<br/><code>0x3E</code><br/><br/>''resource:''<br/><code>test_instance_block_action</code>
 | rowspan="10"| Play
 | rowspan="10"| Server
 | Position
 | {{Type|Position}}
 ...
 | Test
 | {{Type|Prefixed Optional}} {{Type|Identifier}}
 | ID in the <code>minecraft:test_instance</code> registry.
 |-
 | Size X
 | {{Type|VarInt}}
 |
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="9"| ''protocol:''<br/><code>0x3F</code><br/><br/>''resource:''<br/><code>use_item_on</code>
 | rowspan="9"| Play
 | rowspan="9"| Server
 | Hand
 | {{Type|VarInt}} {{Type|Enum}}
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="4"| ''protocol:''<br/><code>0x40</code><br/><br/>''resource:''<br/><code>use_item</code>
 | rowspan="4"| Play
 | rowspan="4"| Server
 | Hand
 | {{Type|VarInt}} {{Type|Enum}}
...
Sent when the client clicks a {{Type|Text Component}} with the <code>minecraft:custom</code> click action. This is meant as an alternative to running a command, but will not have any effect on vanilla servers.
...
{| class="wikitable"
 ...
 ! Notes
 |-
 | rowspan="2"| ''protocol:''<br/><code>0x41</code><br/><br/>''resource:''<br/><code>custom_click_action</code>
 | rowspan="2"| Play
 | rowspan="2"| Server
 | ID
 | {{Type|Identifier}}
...
[[de:Minecraft-Server-Protokoll/Pakete]]
